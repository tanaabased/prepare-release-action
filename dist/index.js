...
var get_inputs_default = () => ({
  ...
  syncBranch: import_core2.default.getInput("sync-branch") || defaultSyncBranch,
  syncEmail: import_core2.default.getInput("sync-email") || defaultSyncEmail,
  syncVerified: process.env.GITHUB_ACTIONS ? import_core2.default.getBooleanInput("sync-verified") : false,
  syncMessage: import_core2.default.getInput("sync-message") || defaultSyncMessage,
  ...
  syncUsername: import_core2.default.getInput("sync-username") || defaultSyncUsername,
...
var main = async () => {
  ...
  try {
    ...
    await import_exec2.default.exec("bunx", [
      "--bun",
      "--package",
    ...
    if (inputs.sync) {
      ...
      await import_exec2.default.exec("git", [
        "config",
        "--local",
