...
- Fixed `version=dev` to resolve a semver-valid version for untagged repositories by preferring matching tags, then `package.json.version`, then `v0.0.0-unreleased.<sha>`.
